            ...
            steps{
                withCredentials([file(credentialsId:'gcp-key', variable : 'GOOGLE_APPLICATION_CREDENTIALS')]){
                    script{
                        ...
                        docker build \
                            --build-arg GCP_PROJECT_ID=${GCP_PROJECT} \
                            --build-arg GOOGLE_APPLICATION_CREDENTIALS_PATH=${GOOGLE_APPLICATION_CREDENTIALS} \
                            -t gcr.io/${GCP_PROJECT}/mlops-project-first:latest .
            ...
            steps{
                ...
                retry(3){
                        ...
                        script{
                            ...
                            gcloud run deploy mlops-project-first --image=gcr.io/${GCP_PROJECT}/mlops-project-first:latest --platform=managed --region=us-central1 --allow-unauthenticated 
