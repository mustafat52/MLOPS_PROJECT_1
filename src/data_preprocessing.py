...
class DataProcessor:
    ...
    def preprocess_data(self, df):
        try:
            ...
            for col in cat_cols:
                ...
                mappings[col] = {
                    label: code
                    for label, code in zip(label_en.classes_, label_en.transform(label_en.classes_))
                }
    ...
    def select_features(self, df):
        try:
            ...
            top_selected_features = top_features['feature'].head(num_features_to_select).values
            logger.info(f"Features Selected : {top_selected_features}")

            top_features_df = df[top_selected_features.tolist() + ["booking_status"]]
    ...
    def save_data(self, df, file_path):
        try:
            ...
            logger.error(f"Error during saving process : {e}")
    ...
    def process(self):
        try:
            ...
            # Apply balancing ONLY on train data (not test)
